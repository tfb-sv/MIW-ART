...
def train(args, cnt, cv_keyz, data, key):
    ...
    ##########################
    if args.is_cv == "ideal":
        print(f"\n\n>>  {args.data_name.upper()} {args.is_cv}_{cnt} Training is COMPLETED.  <<\n")
    elif args.is_cv == "feasible":
        print(f"\n\n>>  {args.data_name.upper()} {args.is_cv}_{cnt} ({key}) Training is COMPLETED.  <<\n")
    elif args.is_cv == "besty":
        print(f"\n\n>>  {args.data_name.upper()} {args.is_cv}_{args.data_folder} Training is COMPLETED.  <<\n")
    ################################################################################################################################################################################
    ################################################################################################################################################################################ END OF THE STORY, THANK YOU FOR ATTEMPTING TO SHOW
